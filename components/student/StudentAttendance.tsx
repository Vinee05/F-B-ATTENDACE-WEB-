...
export function StudentAttendance({ appState, user, onNavigate, onLogout }: StudentAttendanceProps) {
  ...
  const myAttendance = appState.attendance
  ...
  const attendanceByMonth = myAttendance.reduce((acc, record) => {
    ...
    return acc;
  }, [] as Array<{ month: string; present: number; absent: number; excused: number }>).sort((a, b) => a.month.localeCompare(b.month));
  ...
  return (
    ...
    >
      <div className="space-y-6">
        <div>
          <h1 className="text-gray-900">My Attendance</h1>
          <p className="text-gray-600 mt-1">View your attendance records and analytics</p>
        </div>
        ...
        {percentage < 75 && totalSessions > 0 && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="text-yellow-900">Attendance Warning</h3>
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          ...
          <button
            onClick={() => setFilters({ courseId: '', startDate: '', endDate: '' })}
          ...
          {attendanceByMonth.length > 0 ? (
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={attendanceByMonth}>
                ...
                <Bar dataKey="excused" fill="#f59e0b" name="Excused" />
              </BarChart>
            </ResponsiveContainer>
          ) : (
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <div className="p-6 border-b border-gray-200">
            <h3 className="text-gray-900">Session-wise Details</h3>
          </div>
