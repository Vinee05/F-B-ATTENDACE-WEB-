...
interface InstructorLeaveProps {
  appState: AppState;
...
export function InstructorLeave({ appState, setAppState, user, onNavigate, onLogout }: InstructorLeaveProps) {
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl p-6 w-full max-w-md">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-gray-700 mb-2">Upload Document (Optional)</label>
